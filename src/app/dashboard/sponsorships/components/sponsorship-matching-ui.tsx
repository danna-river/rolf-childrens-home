...
export function PaginationControls({
  ...
  // Keep the displayed page in range even if the list shrank under the current page
  // (e.g. filters changed) so the "showing X-Y" counts never go out of bounds.
  ...
  return (
    <div className="flex flex-col gap-3 border-t border-stone bg-ice px-4 py-3 text-sm text-navy/65 sm:flex-row sm:items-center sm:justify-between sm:px-5">
      <p>
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        <label className="flex items-center gap-2 font-semibold text-navy/65">
          ...
          <select
            ...
            className="rounded-md border border-stone bg-white px-2.5 py-2 text-sm font-semibold text-navy outline-none focus:border-teal focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal"
          >
