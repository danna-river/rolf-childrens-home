                ...
                >
                  <div className="min-w-0">
                    <div className="flex min-w-0 items-center gap-2">
                      ...
                      <div className="min-w-0">
                        <p className="text-sm font-semibold text-navy/65">Sponsor</p>
                        <p className="truncate text-base font-bold text-navy">{sponsorLabel}</p>
                        {match.sponsor?.email && (
                          <p className="truncate text-sm text-navy/65">{match.sponsor.email}</p>
                        )}
                      </div>
                    </div>
                    <div className="mt-3 grid gap-2 text-sm text-navy/65 sm:grid-cols-2">
                      <span className="min-w-0 rounded-md border border-stone bg-ice px-3 py-2">
                        <span className="block font-semibold text-navy/65">{recordTypeLabel}</span>
                      ...
                      {match.child_id && (
                        <span className="min-w-0 rounded-md border border-stone bg-white px-3 py-2">
                          <span className="block font-semibold text-navy/65">Child details</span>
                      ...
                      {match.notes && (
                        <span className="min-w-0 rounded-md border border-stone bg-white px-3 py-2 sm:col-span-2">
                          <span className="block font-semibold text-navy/65">Notes</span>
